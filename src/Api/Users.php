...
class Users extends AbstractApi
{
     ...
     *      'fields'    => (string) Whitelist of fields to return for each document. Can also define which fields to exclude by prefixing field names with "-".
     *      'sort'      => (string) Field by which the results should be sorted. Ascending by default, descending if prefixed by "-".
     *      'skip'      => (int) Number of results to skip from the start of the data set. To be used with the limit parameter for paging.
     *      'limit'     => (int) How many results should be returned. To be used with the skip parameter for paging.
     *      'expand'    => (string) List of fields that should be expanded (substitutes their IDs with actual objects). May be nested using the "resource.subResource" format.
     *    ]
     * @return array
