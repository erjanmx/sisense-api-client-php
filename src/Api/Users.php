...
class Users extends AbstractApi
{
     ...
     *                           'active'    => (bool) User state to filter by - true for active users, false for
     *                           inactive users.
     *                           'origin'    => (string) User origin to filter by - ad for active directory or sisense.
     *                           'ids'       => (array) Array of user IDs to get, separated by a comma (,) and without
     *                           spaces. ???
     *                           'fields'    => (string) Whitelist of fields to return for each document. Can also
     ...
     *                           'limit'     => (int) How many results should be returned.
     *                           To be used with the skip parameter for paging.
     *                           'expand'    => (string) List of fields that should be expanded
     *                           (substitutes their IDs with actual objects).
